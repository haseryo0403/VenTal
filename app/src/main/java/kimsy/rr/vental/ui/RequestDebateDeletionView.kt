...
import kimsy.rr.vental.ViewModel.RequestDebateDeletionViewModel
import kimsy.rr.vental.data.Status
import kimsy.rr.vental.ui.CommonComposable.CustomCircularProgressIndicator

@Composable
fun RequestDebateDeletionView(
    viewModel: RequestDebateDeletionViewModel = hiltViewModel(),
    toDebateView: () -> Unit
) {
    ...
    LazyColumn(
        ...
        item {
            Button(
                ...
                onClick = { viewModel.requestDebateDeletion(selectedOption) }
            ) {
